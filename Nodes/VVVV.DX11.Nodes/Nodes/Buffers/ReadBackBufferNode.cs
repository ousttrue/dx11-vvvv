...
{
    [PluginInfo(Name = "ReadBack", Category = "DX11.Buffer", Version = "", Author = "vux", AutoEvaluate = false)]
    public class ReadBackBuffer : IPluginEvaluate, IDX11ResourceDataRetriever, IPartImportsSatisfiedNotification
    {
        [Config("Layout")]
