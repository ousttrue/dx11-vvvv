...
{
    [PluginInfo(Name = "ReadBack", Category = "DX11.Buffer", Version = "Region", Author = "vux", AutoEvaluate = false)]
    public class ReadBackBufferRegionNode : IPluginEvaluate, IDX11ResourceDataRetriever, IPartImportsSatisfiedNotification
    {
        [Config("Layout")]
